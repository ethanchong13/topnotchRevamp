...
const OutsourcedPayrollCard = () => {
  ...
  return (
    ...
    layout
      ...
      className={`text-${isOpen? 'left w-auto':'center w-60 h-64'} bg-stone-200 py-8 px-6 mx-2 my-4 hover:bg-yellow-600 hover:text-slate-200 rounded-2xl`}
    >
        ...
        {isOpen ? (
            ...
            transition={{type:"spring"}}
            className='py-2 px-3'><a className='flex items-center hover:underline hover:text-slate-200' href="https://zom-in.com/spiceIn"><BsArrowReturnRight /> &nbsp;Learn more</a></motion.button>
            </motion.div>
          </motion.div>
        ):null}
