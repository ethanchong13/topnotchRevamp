    ...
    <OutsideClickHandler onOutsideClick={() => setIsOpen(false)}>
      ...
      >
        ...
        >
          <motion.h2
            layout="position"
            className={`${isOpen && "px-3"} text-2xl font-light text-left`}
          >
            Join Us
          </motion.h2>
        </motion.div>
        {isOpen ? (
          ...
          >
            <p className="py-4 leading-6 px-3">
              Want to be a part of this fast-growing HR firm? Drop us your
              updated CV at
            </p>
            <button
              onClick={() => {
              ...
              className="pb-4 leading-6 px-3 cursor-pointer"
            >
              {" "}
              talent.acq@topnotchgroup.com.my
            </button>
          </motion.div>
        ) : null}
      </motion.div>
