...
const EmploymentCard = () => {
  ...
  return (
    ...
    >
        ...
        <motion.h2 layout="position" className={`${isOpen&&'px-3 py-3'} text-2xl font-light text-left`}>Employment Solutions</motion.h2>
        </motion.div>
        {isOpen ? (
            <motion.div 
            initial={{opacity:0}}
            ...
            className=''>
            <p className='py-3 leading-6 px-3 flex items-center'><GiHumanTarget />&nbsp;Talent identification</p>
            <p className='pb-3 leading-6 px-3 flex items-center'><MdMiscellaneousServices />&nbsp;Professional Contracting Services</p>
            <p className='pb-3 leading-6 px-3 flex items-center'><GiHumanPyramid />&nbsp;HR Strategies Consultation</p>
